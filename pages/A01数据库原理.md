...
![](./images/2023-08-03-18-41-images.png)
...
| 术语      | 表示                                 | 说明                 |
|:-------:|:----------------------------------:|:------------------:|
| 函数依赖    | $A→B$                              | 每个A值，都有一个唯一的B值与之对应 |
| 完全函数依赖  | $A\quad\underrightarrow{f}\quad B$ | B依赖于全部A的值          |
| 部分函数依赖  | $A\quad\underrightarrow{p}\quad B$ | B依赖于A的真子集          |
| 传递函数依赖  | $A→B，B→C时，A→C$                     | \                  |
| 非平凡函数依赖 | $A→B时，B⊄A$                         | B非A的子集             |
...
<img src="./images/2023-08-03-19-54-images.png">
